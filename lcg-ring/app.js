...
var seed_step_minus_2_pow_n = (function () {
    var consts;
...
function seed_to_index0(seed, i) {
    if (i === 32) {
        return 0;
    } else if ((seed >>> i) & 1) {
...
function draw(canvas, seeds, indexes) {
    ...
    function drawPointer(rad, len) {
        if (typeof len === "undefined") { len = 0.05; }
        ctx.save();
